...
{
    public class TimeMachineModel : PageModel
    {
        ...
        public DatePrice HighestPrice { get; set; }
        public DatePrice LowestPrice { get; set; }
        public bool QueryComplete { get; set; }
        public TimeMachineModel(JsonPullService jsonPullService, CryptoCalculationService cryptoCalculationService)
        {
        ...
        public void OnGet()
        {
            ...
            if (dateStart != "")
            {
                ...
                (DatePrice, DatePrice) prices = CryptoCalculationService.GetBestDatePricesForBuyingAndSelling(JsonPullService.GetBTCData(unixStart, unixEnd).prices);

                LowestPrice = prices.Item1;
                HighestPrice = prices.Item2;
                QueryComplete = true;
            }
            else
            {
